# MongrelDB Crystal Client - Guides

Task-focused guides for the pure-Crystal MongrelDB HTTP client. For the full
API surface in one place, see the root [README](../README.md).
...
| [errors.md](errors.md) | Exception hierarchy, HTTP-status mapping, recovery patterns |
